export const environment = {
  production: true,
  domainName: 'freightcentralized.com',
  ...
  API_URL: 'https://freight-centralized-server-b71c2fd17354.herokuapp.com/api/v1',
  API_AUTH_URL: 'https://freight-centralized-server-b71c2fd17354.herokuapp.com/auth',
  PUBLIC_API_URL: 'https://freight-centralized-server-b71c2fd17354.herokuapp.com/api/v0',
  WS_URL: 'wss://freight-centralized-server-b71c2fd17354.herokuapp.com/ws',
  auth0: {
